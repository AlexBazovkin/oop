class Student:
    ...
    def __str__(self):
        """определение средней оценки, изменение вывода"""
        grades_count = 0
    ...
    def __lt__(self, other):
        """сравнение студентов по средней оценке за д/з"""
...
class Lecturer(Mentor):
    ...
    def __lt__(self, other):
        """Сравнение лекторов по средней оценке от студентов"""
...
class Reviewer(Mentor):
    def rate_hw(self, student, course, grade):
        """Оценка студенту за домашние задания"""
...
# Лекторы:
best_lecturer_1 = Lecturer('Андрей', 'Шостак')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Василий', 'Полищук')
best_lecturer_2.courses_attached += ['Java']

best_lecturer_3 = Lecturer('Александр', 'Фищенко')
best_lecturer_3.courses_attached += ['Python']

# Проверяющие:
cool_reviewer_1 = Reviewer('Валерий', 'Степанов')
cool_reviewer_1.courses_attached += ['Python']
cool_reviewer_1.courses_attached += ['Java']

cool_reviewer_2 = Reviewer('Александр', 'Ливинский')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['Java']

# Студенты:
student_1 = Student('Анна', 'Орлова')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Константин', 'Щедров')
student_2.courses_in_progress += ['Java']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Виктория', 'Сухорукова')
